  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-gray-200 bg-white transition-all hover:shadow-lg">
      ...
      <div className="p-4">
        ...
        <button onClick={() => onContinue(id)} className="w-full rounded-full bg-[#00A3E0] py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#00A3E0]/90">Continuar</button>
      </div>
    </div>
  )
}
