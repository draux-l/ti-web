          ...
          <div className="rounded-md border border-slate-200 mt-4 overflow-hidden">
            <Table>
              ...
              <TableBody>
                {courses.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={7} className="text-center py-6 text-slate-500">No hay cursos registrados</TableCell>
                  </TableRow>
                ) : courses.map((course) => (
                  <TableRow key={course.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <TableCell>
                      <Badge 
                        ...
                        className={`
                          ${course.status === 'Activo' && 'bg-[#00A3E0] hover:bg-[#008cc0]'}
                          ${course.status === 'Inactivo' && 'bg-slate-200 text-slate-600 hover:bg-slate-300'}
                        `}
                      >
                        {course.status}
                      </Badge>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <form onSubmit={handleEditCourse}>
            <DialogHeader>
              ...
              <DialogDescription>
                Modifica los detalles del curso seleccionado.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="flex flex-col gap-2">
